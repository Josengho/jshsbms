...
public class AdminMemberController {
	...
	public ModelAndView adminMemberMain(@RequestParam Map<String, String> dateMap , HttpServletRequest request)  throws Exception{
		...
		String searchWord       = dateMap.get("searchWord");			// 단어 검색
		String searchType       = dateMap.get("searchType");			// 이름 혹은 아이디
		String [] tempDate       = null; 
		String beginDate         = "";		// 조건에서의 시작 날짜
		String endDate           = "";		// 조건에서의 마지막 날짜
