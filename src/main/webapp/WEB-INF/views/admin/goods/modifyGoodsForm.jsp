...
<script>
	...
	function fn_modify_goods(goodsId, attribute){
	 ...
	 function deleteGoods(goodsId,imageId,imageFileName){
		...
		<div class="tab_content" id="tab7">
			<form id="file_form" method="post" enctype="multipart/form-data">
				...
				<table class="list_view">
							...
							<c:otherwise>
								<tr id="${itemNum.count-1}">
									...
									<td>
										...
										<input type="button" value="삭제" class="btn btn-danger btn-xs" onClick="deleteImageFile('${item.goodsId}','${item.imageId}','${item.fileName}','${itemNum.count-1}','true')" />
									</td>
								</tr>
					...
					<tr align="center">
						<td colspan="5">
							<input type="button" value="삭제하기" class="btn btn-outline-primary" onClick="deleteGoods('${item.goodsId}','${item.imageId}','${item.fileName}')" />
						</td>
					</tr>
					</c:forEach>
					<tr align="center">
