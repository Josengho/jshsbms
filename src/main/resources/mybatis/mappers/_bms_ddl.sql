...
CREATE TABLE T_SHOPPING_NOTICE(
	...
	WRITE_TIME 			DATE,
    CONSTRAINT NOTICE_PK_NOTICE_ID PRIMARY KEY (NOTICE_ID)
);
...
CREATE TABLE T_SHOPPING_CART(
	...
	CONSTRAINT CART_PK_CART_ID PRIMARY KEY (CART_ID),
	CONSTRAINT CART_FK_MEMBER_ID FOREIGN KEY (MEMBER_ID) REFERENCES T_SHOPPING_MEMBER(MEMBER_ID),
	CONSTRAINT CART_FK_GOODS_ID FOREIGN KEY (GOODS_ID) REFERENCES T_SHOPPING_GOODS(GOODS_ID)
);
